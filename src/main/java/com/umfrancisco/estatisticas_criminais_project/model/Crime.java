...
public class Crime {
	...
	public Crime(Cidade cidade, Integer ano, Integer homicidio, Integer furto, Integer roubo,
	...
	public String toString() {
		return "Crime [cidade=" + cidade + ", ano=" + ano + ", homicidio=" + homicidio + ", furto=" + furto + ", roubo="
				+ roubo + ", furtoRouboVeiculos=" + furtoRouboVeiculos + "]";
	}
}
